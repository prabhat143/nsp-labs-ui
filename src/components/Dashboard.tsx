      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {dashboardCards.map((card, index) => (
          <div
            ...
            className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-200 cursor-pointer group"
          >
            <div className="flex items-start space-x-4">
              <div className={`p-4 rounded-xl ${card.color} ${card.hoverColor} transition-colors group-hover:scale-110 transform duration-200`}>
            ...
            {samples.slice(0, 3).map((sample) => (
              <div key={sample.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">{sample.location}</p>
