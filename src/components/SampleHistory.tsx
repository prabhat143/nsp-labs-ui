      ...
      <div className="bg-white rounded-2xl shadow-lg p-8">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">Track the status of all your submitted samples</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        {samples.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">You haven't submitted any samples for testing.</p>
            <button
          ...
          samples.map((sample) => (
            <div key={sample.id} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                      ...
                      <p className="text-gray-600 font-mono text-sm">{sample.id}</p>
                    </div>
                    <div>
                  ...
                  {sample.subCategory && (
                    <div className="mb-4">
                      ...
                      <p className="text-gray-600">{sample.subCategory}</p>
                    </div>
                  )}
